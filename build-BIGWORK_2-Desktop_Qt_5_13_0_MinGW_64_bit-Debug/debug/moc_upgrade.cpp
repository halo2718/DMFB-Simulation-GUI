...
QT_MOC_LITERAL(1, 8, 13), // "upgradeSignal"
...
QT_MOC_LITERAL(6, 93, 23) // "on_pushButton_4_clicked"
    ...
    "Upgrade\0upgradeSignal\0\0on_pushButton_clicked\0"
...
void Upgrade::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Upgrade *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->upgradeSignal((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Upgrade::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Upgrade::upgradeSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Upgrade::upgradeSignal(int _t1)
{
